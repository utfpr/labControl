...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const menus = [
    ...
    { nome: "Reservas", href: "/dashboard/reservas", icone: CalendarDays },
  ...
  return (
    ...
    <div className="flex h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full">
        {/* Cabeçalho (Topbar) */}
        {/* 👈 Adicionamos classes dark:bg-slate-950 dark:border-slate-800 para o topo escurecer */}
