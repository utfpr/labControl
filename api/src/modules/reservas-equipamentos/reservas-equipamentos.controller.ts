...
export class ReservasEquipamentosController {
  ...
  async aprovar(@Param('id') id: string) {
    return this.reservasEquipamentosService.alterarStatus(id, Status.APROVADA);
  }
  ...
  async rejeitar(@Param('id') id: string) {
    return this.reservasEquipamentosService.alterarStatus(id, Status.REJEITADA);
  }

  @Patch(':id/cancelar')
  @ApiOperation({ summary: 'Cancela a reserva (Pode ser feito pelo próprio utilizador)' })
  async cancelar(@Param('id') id: string) {
    return this.reservasEquipamentosService.alterarStatus(id, Status.CANCELADA);
  }
  ...
  async finalizar(@Param('id') id: string) {
    return this.reservasEquipamentosService.alterarStatus(id, Status.FINALIZADA);
  }
}